...
color_match = {'green': 1, 'red': 2, 'blue': 3, 'purple': 4, 'yellow': 5}
# 保存为txt文件
...
b, e, sf, ef = {}, {}, {}, {}
Step = {'step': 0}
match_color = {1: 'green', 2: 'red', 3: 'blue', 4: 'purple', 5: 'yellow'}
...
f.write('$KMS:0,100,200,2000!'+'\n')
f.write('$KMS:0,290,200,2000!'+'\n')
f.write('$KMS:10,320,120,1000!'+'\n')
f.write('$KMS:0,290,200,1000!'+'\n')
f.write('$KMS:-65,292,200,1000!'+'\n')
f.write('$KMS:-65,288,120,1000!'+'\n')
f.write('$KMS:-65,292,200,1000!'+'\n')
f.write('$KMS:0,290,200,1000!'+'\n')
f.write('$KMS:10,320,120,1000!'+'\n')
f.write('$KMS:0,290,200,1000!'+'\n')
f.write('$KMS:72,285,200,1000!'+'\n')
f.write('$KMS:72,300,115,1000!'+'\n')
f.write('$KMS:72,285,200,1000!'+'\n')
f.write('$KMS:-65,292,200,1000!'+'\n')
f.write('$KMS:-65,288,120,1000!'+'\n')
f.write('$KMS:-65,292,200,1000!'+'\n')
